...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signupemail = findViewById(R.id.email_login);
        signuppass = findViewById(R.id.pass_login);
        signupbtn = findViewById(R.id.loginBtn);
        nav_to_login = findViewById(R.id.gotologin);
        ...
        signupbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mail.isEmpty() || pass.isEmpty()) {
                    ...
                    Toast.makeText(SignUpActivity.this, "Password Should be 8 Character Long", Toast.LENGTH_SHORT).show();
        ...
        if (firebaseUser != null) {
            firebaseUser.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Toast.makeText(SignUpActivity.this, "Verification Email Sent, Verify and Login", Toast.LENGTH_SHORT).show();
